...
INSERT INTO SELECTORS_TBL (id,title, parent_selector_id) VALUES (default,'Data processing, Web portals, E-marketing' , (SELECT id FROM SELECTORS_TBL WHERE title = 'Information Technology and Telecommunications'));
INSERT INTO SELECTORS_TBL (id,title, parent_selector_id) VALUES (default,'Programming, Consultancy' , (SELECT id FROM SELECTORS_TBL WHERE title = 'Information Technology and Telecommunications'));
INSERT INTO SELECTORS_TBL (id,title, parent_selector_id) VALUES (default,'Software, Hardware' , (SELECT id FROM SELECTORS_TBL WHERE title = 'Information Technology and Telecommunications'));
INSERT INTO SELECTORS_TBL (id,title, parent_selector_id) VALUES (default,'Telecommunications' , (SELECT id FROM SELECTORS_TBL WHERE title = 'Information Technology and Telecommunications'));
